...
<html>
<head>
	<title>Nova processo para votação</title>
</head>
...
<div style="text-align:center; margin:10px auto 10px auto; padding:0;">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="600" style="width:600px; margin:0 auto; border-left:1px solid #aaa; border-right:1px solid #aaa; padding:10px;">
		<tr>
			<td style="text-align:left; font-size:16px; color:#333; font-weight:bold;"><span style="text-align:left; font-size:16px; color:#333; font-weight:bold;">CA Fund&atilde;o - Processo reprovado</span></td>
		</tr>
		<tr>
			<td style="text-align:left; font-size:12px; color:#333; margin-top:;">
				<p style="text-align:left;">Caro(a) Sr.(a) <strong>{name}</strong>,</p>
				<p style="text-align:left;">O processo <strong>'.$row_email_risco["ccc_num"].'</strong> do cliente <strong>'.$row_email_risco["nome"].'</strong> foi reprovado.</p>
